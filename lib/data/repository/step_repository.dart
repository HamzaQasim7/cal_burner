...
//     // Formula: steps * 0.04 * weight(kg)
//     // This is an approximation - actual burn depends on many factors
//     return steps * 0.04 * weightKg;
//   }
//
//   // Calculate distance from steps (in meters)
//   double calculateDistanceFromSteps(int steps) {
//     // Average step length approximation: 0.7 meters
//     const double averageStepLengthMeters = 0.7;
//     return steps * averageStepLengthMeters;
//   }
//
//   // Calculate distance in kilometers
//   double calculateDistanceInKm(int steps) {
//     return calculateDistanceFromSteps(steps) / 1000.0;
//   }
//
//   // Calculate distance in miles
//   double calculateDistanceInMiles(int steps) {
//     return calculateDistanceInKm(steps) * 0.621371;
//   }
//
